...
void io_redisplay_visible_monsters(dungeon *d, pair_t cursor)
{
...
static uint32_t io_inspect_monster(dungeon *d)
{
  ...
  mvprintw(0, 0, "Choose a monster.  'g' or '.' to inspect; 'r' to perform a ranged attack; 's' to perform a spell; 'ESC' to cancel.");
...
void io_handle_input(dungeon *d)
{
  ...
  do {
    ...
    case 'I':
      ...
      break;
    case 'L':
      fail_code = io_inspect_monster(d);
      // Target Monster -->
      break;
    case 'q':
